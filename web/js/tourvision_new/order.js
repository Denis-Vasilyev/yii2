$(document).ready(function () {
    ...
    $('.js-show-error ').click(function () {
        $(this).closest('.panel').find('.js-error').addClass('has-error')
    ...
    // СЃРѕР·РґР°РµРј РїРµСЂРІС‹Р№ РїРёРєРµСЂ
        ...
        onType: function (str) {
            ...
            if (str !== "" && "12".startsWith(str.toLowerCase())) {
                selectizeMetro.addOption({
                    value: "12",
                    text: "РђРґРјРёСЂР°Р»С‚РµР№СЃРєР°СЏ",
    ...
    var $selectCity = $('#city').selectize({
        ...
        onType: function (str) {
            //here load logic
            selectizCity.clearOptions();

            if (str !== "" && "12".startsWith(str.toLowerCase())) {
                selectizCity.addOption({
                    value: "12",
                    text: "РњРѕСЃРєРІР°",
    ...
    var selectizCity = $selectCity[0].selectize;

$(document).ready(function () {
    ...
    $('.js-control-show').on('click', function () {
        $(this).closest('.hotelFilter').find('.js-control.block').removeClass('block');
        $(this).closest('.hotelFilter').find('.bth__inp-arrr.active').removeClass('active');
...
$(function () {
    ...
    $('select[name="hotelRating-adults"]').SumoSelect();
    $('select[name="hotelRating-rating"]').SumoSelect();
    $('select[name="hotelRating-review"]').SumoSelect();
    ...
    $('.js-act-rating-block').on('click' , function () {
        $('.topSection-wide__ratings-block').show();
        $(this).closest('.topSection-wide__section').hide()
    });

    $('.topSection-wide__cross').on('click' , function () {
        $('.topSection-wide__ratings-block').hide();
        $('.js-act-hide').show();
        $('span.form-rating__bubble-num').text('5,0')
    })

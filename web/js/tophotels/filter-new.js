$(document).ready(function () {
    ...
    $('.filter-new__suggest-close').on('click', function () {
        $(this).closest('.filter-new').find('.filter-new__suggest').removeClass('active');
        $(this).closest('.filter-new').find('.js-hidden').show();
        $('.filter-new__lb').removeClass('active-border ');
        $('.filter-new-js-search').prop('checked', false);
        $(this).closest('.filter-new__item').removeClass('active');
    });
    ...
    $('.js-act-total').on('click', function () {
        $(this).find('.js-show-total').show();
        $(this).find(".filter-new__lb").addClass('w-auto')
    })

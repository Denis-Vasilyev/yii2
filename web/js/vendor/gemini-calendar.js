    ...
    var DatePicker = function ($el, options) {
        ...
        var core = {
            ...
            _generateDateDOM: function () {
                ...
                dateDomStr += '<div id="'+ datepicker.pickerBlockId +'">';
                dateDomStr += '<div class="form-popup__mdl">';
                dateDomStr += '<ul id="dateMonthList" class="form-popup__month-list">';
                (function() {
                    var d = new Date();
                ...
                dateDomStr += '<div data-role="' + type + '" class="gmi-picker-panel gmi-date-picker ' + hasTimeClass + '" style="display: none;">' +
                    ...
                    + monthDom +
                    '<em data-action="next" class="gmi-date-picker__header__icon-btn gmi-picker-panel__btn--next fa fa-angle-down"></em>' +
                    '<em data-action="prev" class="gmi-date-picker__header__icon-btn gmi-picker-panel__btn--prev fa fa-angle-up"></em>' +
                    '</div>' +
            ...
            _generateRangeDateDOM: function () {
                ...
                // месяцы вверху календаря
                rangeDateDomStr += '<div id="'+ datepicker.pickerBlockId +'">';
                rangeDateDomStr += '<div class="form-popup__mdl">';
                rangeDateDomStr += '<ul id="dateMonthList" class="form-popup__month-list">';
                (function() {
                    var d = new Date();
                ...
                rangeDateDomStr += '<em data-action="prev-month" class="gmi-date-range-picker__header__icon-btn gmi-date-range-picker__btn--prev gmi-date-range-picker__btn--prev-month fa fa-angle-left"></em>' +
                    '</div>'
                    ...
                    '<em data-action="next-month" class="gmi-date-range-picker__header__icon-btn gmi-date-range-picker__btn--next gmi-date-range-picker__btn--next-month fa fa-angle-right"></em>' +
                    '</div>'
...
/**
 * Простой способ создания датепикера
 * @param id
 * @param onchange
 */
